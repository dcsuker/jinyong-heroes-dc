              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={stat.label}>
                    ...
                    <div className="h-3 bg-ink-light rounded-full overflow-hidden">
                      <div className={`h-full ${stat.color} transition-all duration-300`} style={{ width: `${(stat.current / stat.max) * 100}%` }} />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-ink-dark border border-gold/30 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: '悟性', value: player.wis, icon: '🧠' },
            ...
            <div className="bg-ink-dark border border-gold/30 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={equip.slot} className="aspect-square bg-ink border border-gold/30 rounded flex flex-col items-center justify-center">
                    ...
                    {player.equipped[equip.slot as keyof typeof player.equipped] ? (
                      ...
                      <span className="text-xs text-parchment/30">空位</span>
                    )}
                  </div>
                ))}
              </div>
            ...
            <div className="bg-ink-dark border border-gold/30 p-6 rounded-lg">
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {player.skills.map((skillId) => {
                  ...
                  const skillType = String(skill.type);
                  return (
                    <div key={skillId} className="flex items-center gap-3 bg-ink p-3 rounded">
                      <span className="text-2xl">
                        {skillType.includes('剑') ? '🗡️' : skillType.includes('掌') ? '✋' : skillType.includes('内') ? '☯️' : skillType.includes('轻') ? '💨' : '⚔️'}
                      </span>
        ...
        {activeTab === 'reputation' && (
          <div className="max-w-2xl mx-auto space-y-6">
            <div className="bg-ink-dark border border-gold/30 p-6 rounded-lg">
              ...
              <p className="text-sm text-parchment/60 mt-2">影响正派人物态度与门派路线。</p>
            </div>
            ...
            <div className="bg-ink-dark border border-gold/30 p-6 rounded-lg">
              ...
              <p className="text-sm text-parchment/60 mt-2">影响邪派人物态度与武学分支。</p>
            </div>
